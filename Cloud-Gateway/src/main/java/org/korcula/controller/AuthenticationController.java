...
import org.korcula.model.AuthenticationResponse;
...
public class AuthenticationController {
	...
	public ResponseEntity<AuthenticationResponse> login(@AuthenticationPrincipal OidcUser oidcUser, Model model,
		...
		AuthenticationResponse authenticatioonResponse = AuthenticationResponse.builder()
		...
		return new ResponseEntity<>(authenticatioonResponse, HttpStatus.OK);
	}
}
